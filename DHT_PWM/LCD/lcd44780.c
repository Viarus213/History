...
//------------------------------------------------------------------------------
//    ******* Seting distance between number and unit ********
//------------------------------------------------------------------------------
/*uint8_t units_control(uint8_t x){
  if((x <= -128)  &&  (x > 99)) distance_regulation = 4;
  if((x >= -99) &&  (x < -9)) distance_regulation = 3;
  if((x >= -9)  &&  (x < 0))  distance_regulation = 2;
  if((x >= 0)   &&  (x <= 9)) distance_regulation = 1;
  if((x > 9)    &&  (x <= 99))  distance_regulation = 2;
  if((x > 99)   &&  (x <= 127)) distance_regulation = 3;

  return distance_regulation;
  }*/
//------------------------------------------------------------------------------
//
//    ******* Sending temperature to the LDC display ********
//
//------------------------------------------------------------------------------
void lcd_temp(int8_t temperature){
  //Regulation of TEMPERATURE ∞C displaying
  lcd_locate(0,0);
  lcd_str("Temp: ");
  lcd_int(temperature);
  lcd_str("\x82""C");
